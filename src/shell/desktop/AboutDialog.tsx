...
const AboutDialog = () => {
  ...
  const titlebarDrag = useDrag({
    shouldStart: (e) => {
      if ((e.target as HTMLElement).closest("[data-window-button]"))
        return false;
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center px-6 pb-6">
              ...
              <h1 className="mt-4 text-xl font-semibold text-white/90">aisu</h1>

              <p className="mt-1 text-sm text-white/50">AI Web OS</p>

              <p className="mt-3 text-xs text-white/40">{VERSION_TEXT}</p>
