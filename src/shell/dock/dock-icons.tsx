...
export const AiChatIcon = ({ size = 48 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="6" y="8" width="36" height="26" rx="6" stroke="url(#aiChatGrad)" strokeWidth="2" fill="none" />
    <path d="M18 34L14 40V34" stroke="url(#aiChatGrad)" strokeWidth="2" strokeLinejoin="round" />
    {/* Sparkle */}
...
export const TerminalIcon = ({ size = 48 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="5" y="8" width="38" height="32" rx="5" stroke="url(#termGrad)" strokeWidth="2" fill="none" />
    <rect x="5" y="8" width="38" height="8" rx="5" fill="url(#termGrad)" opacity="0.15" />
...
export const TextEditorIcon = ({ size = 48 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="8" y="6" width="32" height="36" rx="4" stroke="url(#editorGrad)" strokeWidth="2" fill="none" />
    <path d="M8 14H40" stroke="url(#editorGrad)" strokeWidth="1" opacity="0.3" />
...
export const ImageViewerIcon = ({ size = 48 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="6" y="8" width="36" height="32" rx="4" stroke="url(#imgGrad)" strokeWidth="2" fill="none" />
    <circle cx="16" cy="18" r="3" fill="#FBBF24" opacity="0.7" />
    <path d="M6 32L16 24L24 30L32 20L42 28V36C42 38.2091 40.2091 40 38 40H10C7.79086 40 6 38.2091 6 36V32Z" fill="url(#imgGrad)" opacity="0.15" />
...
export const AppMarketIcon = ({ size = 48 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="8" y="8" width="13" height="13" rx="3" stroke="url(#marketGrad)" strokeWidth="2" fill="url(#marketGrad)" fillOpacity="0.15" />
    <rect x="27" y="8" width="13" height="13" rx="3" stroke="url(#marketGrad)" strokeWidth="2" fill="url(#marketGrad)" fillOpacity="0.1" />
    <rect x="8" y="27" width="13" height="13" rx="3" stroke="url(#marketGrad)" strokeWidth="2" fill="url(#marketGrad)" fillOpacity="0.1" />
    <rect x="27" y="27" width="13" height="13" rx="3" stroke="url(#marketGrad)" strokeWidth="2" fill="url(#marketGrad)" fillOpacity="0.15" />
  </svg>
)
